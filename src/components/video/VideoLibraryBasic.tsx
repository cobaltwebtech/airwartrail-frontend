...
function VideoLibraryContent({
	...
	// Free library does not need auth check so we leave useSubStatus hook out
	...
	const buildVideoUrl = useCallback(
		(videoId: string) => `/watch/library_${libraryId}/basic_${videoId}`,
		[libraryId],
	);
 ...
 * ```
 */
export function VideoLibraryBasic(props: VideoLibraryProps) {
	return (
		<QueryProvider>
...
export default VideoLibraryBasic;
