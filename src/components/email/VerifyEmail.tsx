...
export const VerifyEmail: React.FC<VerifyEmailProps> = ({ newEmail, url }) => {
  return (
    <Html>
      <Head />
      <Preview>Verify Your New Email</Preview>
      <Tailwind>
              ...
              <Row>
                <Column className="text-center">
                  ...
                  <Text className="text-base text-stone-700">
                    Your new email address is set to {newEmail}. If you did not
                    request this change, please ignore this email.
                  </Text>
                  <Text className="text-base text-stone-700">
