/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7bae5c9450d0acbdcb4ce29cf1490247)
// Runtime types generated with workerd@1.20260305.0 2026-02-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV_AUTH: KVNamespace;
		DB_AUTH: D1Database;
		RATE_LIMIT_BASIC: RateLimit;
		RATE_LIMIT_PREMIUM: RateLimit;
		ASSETS: Fetcher;
		...
		AWT_PREMIUM_LIBRARY_ID: string;
		AWT_BASIC_LIBRARY_ID: string;
		AWT_CMS_API_URL: string;
		AWT_CMS_API_KEY: string;
		AWT_CMS: Fetcher /* airwartrail-cms */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "BETTER_AUTH_API_KEY" | "RESEND_API_KEY" | "TURNSTILE_SECRET_KEY" | "PUBLIC_TURNSTILE_SITE_KEY" | "UMAMI_ID" | "STRIPE_WEBHOOK_SECRET" | "PUBLIC_STRIPE_KEY" | "STRIPE_SECRET_KEY" | "AWT_PREMIUM_LIBRARY_ID" | "AWT_BASIC_LIBRARY_ID" | "AWT_CMS_API_URL" | "AWT_CMS_API_KEY">> {}
}
